...
def get_hardware_performance_zigzag(
    ...
    #     workload_parser_stage,  # Parses the ONNX Model into the workload
    ...
    #     RemoveUnusedMemoryStage, # Remove unnecessary memory instances
    #     opt_stage, # Reduces all CMEs, returning minimal EDP one
    ...
    # ],
        ...
        maximize_hardware_utilization=False, # only evaluate spatial mapping with top2 utilization (fast simulation)
        enable_weight_diagonal_mapping=False,  # required by SpatialMappingGeneratorStage
