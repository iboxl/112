...
class DimcArrayUnit(ImcUnit):
    ...
    @staticmethod
    def get_mapped_oa_dim(layer, wl_dim, bl_dim, wl_dim_size, bl_dim_size):
        """
        ...
        # if mapped_rows_total >= 1:
        #     # print(f"old is row {mapped_rows_total}, new is {bl_dim_size}")
        #     mapped_rows_total = bl_dim_size 
        #     mapped_rows_for_adder = mapped_rows_total
        # if mapped_cols >= 1:
        #     # print(f"old is col {mapped_cols}, new is {wl_dim_size}")
        #     mapped_cols = wl_dim_size
    ...
    def get_energy_for_a_layer(self, layer, mapping):
        ...
        mapped_rows_total, mapped_rows_for_adder, mapped_cols, macro_activation_times = DimcArrayUnit.get_mapped_oa_dim(layer, self.wl_dim, self.bl_dim, self.wl_dim_size, self.bl_dim_size)
        self.mapped_rows_total = mapped_rows_total

        # # # # # # # # #  # # # # # # # # # # # # # # # # # # modified by Pro 511 # # # # # # # # # # # # # # #  
        # mapped_rows_total = self.bl_dim_size
        # mapped_rows_for_adder = mapped_rows_total
        # mapped_cols = self.wl_dim_size
        # assert mapped_rows_total == self.bl_dim_size
        # assert mapped_rows_for_adder == mapped_rows_total
        # assert mapped_cols == self.wl_dim_size
        # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # 
