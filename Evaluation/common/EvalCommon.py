...
def temporary_runtime_config(objective="Latency", time_limit=120, mip_focus=1,
    ...
    old_state = {
        ...
        "FLAG.ABLATION_FORCE_DOUBLE_BUFFER": getattr(FLAG, "ABLATION_FORCE_DOUBLE_BUFFER", False),
    ...
    try:
        ...
        FLAG.ABLATION_FORCE_DOUBLE_BUFFER = old_state["FLAG.ABLATION_FORCE_DOUBLE_BUFFER"]
